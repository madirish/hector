...
from twisted.conch.ssh import common, keys, transport, service
import MySQLdb
...
class SSHUserAuthServer(service.SSHService):
    ...
    def auth_password(self, packet):
        ...
        log.msg('Login attempt with this username and password: %s %s' % (self.user, password))
...
def conch_mysql_connect(username, password, host, database):
    global conch_username, conch_password, conch_host, conch_database
    conch_username = username
    conch_password = password
    conch_host = host
    conch_database = database
