...
<table class="table" id="vuln_details">
	<tbody>
	<tr><td>Type</td><td><?php echo $vuln_details->get_vuln()->get_name();?></td></tr>
	<tr><td>Description</td><td><?php echo $vuln_details->get_vuln()->get_description();?></td></tr>
	<tr><td>CVE</td><td><?php echo $vuln_details->get_vuln()->get_cve();?></td></tr>
	<tr><td>OSVDB</td><td><?php echo $vuln_details->get_vuln()->get_osvdb();?></td></tr>
	...
	<tr><td>Host</td><td><a href=?action=host_details&id=<?php echo $vuln_details->get_host_id();?>><?php echo $vuln_details->get_host_id();?></a></td></tr>
	<tr><td>Discovered</td><td><?php echo $vuln_details->get_datetime();?></td></tr>
	<tr><td>Last seen</td><td><?php echo $vuln_details->get_datetime();?></td></tr>
