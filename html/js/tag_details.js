...
$(document).ready(function(){
	...
	drawDoughnutChart("tag-incidents","incidentpercent");
	drawDoughnutChart("tag-articles","articlepercent");
	drawDoughnutChart("tag-vulns", "vulnpercent");
	drawDoughnutChart("tag-hosts", "hostpercent");
})